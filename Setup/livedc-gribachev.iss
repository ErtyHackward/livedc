...
[INI]
Filename: {userappdata}\LiveDC\LiveDC.ini; Section: "General"; Key: Hubs; String: 10.10.0.1
Filename: {userappdata}\LiveDC\LiveDC.ini; Section: "General"; Key: UpdateHubs; String: False
...
Filename: {userappdata}\LiveDC\LiveDC.ini; Section: "General"; Key: PortCheckUrl; String: http://10.10.0.1/dc/checkip.php
