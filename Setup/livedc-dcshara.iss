...
Source: ..\LiveDC\bin\Release\Plugins\DcShara.ru.dll; DestDir: {app}\Plugins\; Flags: ignoreversion
...
OutputBaseFilename=setup_livedc_dcshara.ru
...
[INI]
Filename: {userappdata}\LiveDC\LiveDC.ini; Section: "General"; Key: Hubs; String: allavtovo.ru
Filename: {userappdata}\LiveDC\LiveDC.ini; Section: "General"; Key: UpdateHubs; String: True
Filename: {userappdata}\LiveDC\LiveDC.ini; Section: "General"; Key: OpenStartPage; String: True
Filename: {userappdata}\LiveDC\LiveDC.ini; Section: "General"; Key: StartPageUrl; String: http://dcshara.ru
