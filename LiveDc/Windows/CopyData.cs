...
namespace Win32
{
        ...
        protected override void WndProc(ref System.Windows.Forms.Message m)
        {
            if (m.Msg == WM_COPYDATA)
            {
                ...
                if (cds.cbData > 0)
                {
                    ...
                    XmlSerializer b = new XmlSerializer(typeof(CopyDataObjectData));
    ...
    /// </summary>
    [Serializable()]
    public class CopyDataObjectData
    {
        /// <summary>
        ...
        public byte[] FastSerialize()
        {
            return Encoding.Default.GetBytes(string.Format("<?xml version=\"1.0\" encoding=\"windows-1251\"?><CopyDataObjectData xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><Data xsi:type=\"xsd:string\"><![CDATA[{0}]]></Data><Sent>{1}</Sent><Channel>{2}</Channel></CopyDataObjectData>", this.Data.ToString(), this.Sent.ToString("o"), Uri.EscapeDataString(this.Channel)));
        }
    }
